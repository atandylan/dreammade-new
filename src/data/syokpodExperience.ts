...
export const syokpodGtEdition: SyokPodEdition = {
  ...
  defaultViewIndex: 1,
  options: [
    { id: "copper", name: "Copper", displayName: "Copper", colour: "#a95e3d", images: ["/products/syokpod/gt/syokpod-gt-copper-01.webp", "/products/syokpod/gt/syokpod-gt-copper-02.webp", "/products/syokpod/gt/syokpod-gt-copper-body.webp"] },
...
export const syokpodGtExperience: SyokPodExperience = withNarratives({
  ...
  storySlides: [
    { eyebrow: "Form", title: "Copper and silver with a sharper edge.", body: "Both metallic finishes keep the familiar V2 body while pushing the object into collector territory.", image: "/products/syokpod/gt/syokpod-gt-copper-02.webp", imageAlt: "SyokPod GT Copper front-facing view", tone: "red" },
