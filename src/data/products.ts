...
export const products: Product[] = [
  ...
  product({
    ...
    variants: {
      standardColourways: [],
      specialEditions: [
        variant("gt-edition", "GT Edition", "special-edition", "#a95e3d", "/products/syokpod/gt/syokpod-gt-cooper-04.webp"),
    ...
    images: { primary: "/products/syokpod/gt/syokpod-gt-cooper-04.webp", svg: deviceSvg.syokpodGt },
    specs: [
      { label: "Battery", value: "450 mAh" },
      { label: "Charging Port", value: "Type-C" },
      { label: "Screen", value: "LCD" }
